...
(6) create 3 files in sorted_turnstile_group_data for each turnstile group, containing only data relevant to that turnstile group. Note that each file is named with C/A,UNIT at the beginning of the file name 
	(a) files of the form C/A,UNIT_ttl_vol_data.csv contain the subset of the data relevant sorted as in (2)
	(b) files of the form C/A,UNIT_entry_data.csv contain the subset of the data relevant sorted as in (3)
	(c) files of the form C/A,UNIT_exit_data.csv contain the subset of the data relevant sorted as in (4)
